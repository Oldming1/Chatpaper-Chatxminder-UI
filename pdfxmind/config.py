"""OpenAI API"""
APIBASE = "https://api.openai.com/v1"                    # OpenAI API base, default is "https://api.openai.com/v1" for now (Leave it as empty if you are not sure)
APIKEYS = ["yourapikey"]
MODEL = "gpt-3.5-turbo-1106"
MAXTOKEN = 4000                 # Max token number for each request (Cutoff is performed when the number of tokens exceeds this value)
LANGUAGE = "Chinese"            # Only partially support Chinese
...
# Special title
ABS_MATCHSTR = "ABSTRACT|Abstract|abstract|摘要"
INTRO_MATCHSTR = "I.[\s]{1,3}(INTRODUCTION|Introduction|introduction|引言)"
REF_MATCHSTR = "Reference|REFERENCE|Bibliography|参考文献"
APD_MATCHSTR = "APPENDIX|Appendix|附录"  # Not used for now
# General title
